...
def get_args():
    ...
    ##データのオプション
    parser.add_argument("--src_length", type=int, default="5", help="input train batch size")
    parser.add_argument("--tgt_length", type=int, default="5", help="input test batch size")
