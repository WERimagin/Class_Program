...
def get_args():
    ...
    parser.add_argument("--train_batch_size", type=int, default="4", help="input train batch size")
    parser.add_argument("--test_batch_size", type=int, default="1", help="input test batch size")

    ##データのオプション
    parser.add_argument("--src_length", type=int, default="8", help="input train batch size")
    parser.add_argument("--tgt_length", type=int, default="8", help="input test batch size")
    ...
    parser.add_argument("--dropout", type=float, default="0.1", help="input epoch number")
    ...
    parser.add_argument("--use_train_data", type=bool, default=True, help="input epoch number")
    parser.add_argument("--model_name", type=str, default="model.pth", help="input epoch number")
